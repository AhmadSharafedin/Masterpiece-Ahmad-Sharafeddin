                ...
                <div class="container">
                    ...
                    <form method="post" action="{{route('service.store')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input oninput="myFunctionForP()" name="no_of_hours" type="number" class="form-control"
                                       ...
                                       placeholder="Default is 1 Hour" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input oninput="myFunctionForP()" name="no_of_workers" value=1 type="number"
                                       ...
                                       placeholder="Default is 1 Person" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input name="price" value="5" type="number" class="form-control" id="price"
                                        readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <textarea rows="3" name="description" type="text" class="form-control" id="description"
                                          placeholder="If you have any notes please tell us... "></textarea>
                            </div>
                        </div>
