...
@section('content')
    <div class="container">
        @if (Route::has('login'))
                                ...
                                <div style="margin-top: 10px">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <h6 style=" text-transform: capitalize">user name
                                                : {{$quary->user->name}}</h6>
                                            ...
                                            <h6 style=" text-transform: capitalize">Type of service
                                        ...
                                        <div class="col">
                                            <h6>City: {{$quary->city}}</h6>
                                            <h6 style=" text-transform: capitalize"><i class="fa fa-map-marker"
                                            ...
                                            <h6><i class="fa fa-money-bill-alt" style="font-size:24px"> :</i>
                                                {{$quary->price}} JOD</h6>
                                            <small style="font-weight: bold">Created at : {{$quary->created_at}}</small>
                                            ...
                                            <div class="row justify-content-xl-around align-items-end mt-2 mb-2">
                                                ...
                                                @else
                                                    <form style="margin:auto; display: inline-block" method="post"
                                                        ...
                                                        @csrf
                                                        <input name="is_approve" type="hidden" value="waiting">
                                                        <button type="submit" class="btn btn-warning">On Waiting
                                                        </button>
                                                    </form>
            ...
            @else
                <div class="container ">
                    <h1 style="color: red">ONLY Admin Can Access Please Login First</h1>
                </div>
            @endauth
        @endif
    </div>
